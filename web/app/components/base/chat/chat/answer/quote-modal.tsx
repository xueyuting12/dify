...
import { Word as WordIcon, Link as LinkIcon } from '@/app/components/base/icons/src/public/chat'
        ...
        {quoteList.map((item, index) => 
          <div 
            ...
            <div className='flex mb-3'>
              ...
              <div>
                <div className='align-text-left text-xs text-gray-700'>语义检索：{item.score.toFixed(4)}</div>
