...
class CustomAgentAppConfig(EasyUIBasedAppConfig):
    """
    Agent Chatbot App Config Entity.
    """
    custom_agent: Optional[AgentEntity] = None


class CustomAgentAppConfigManager(BaseAppConfigManager):
    @classmethod
    def get_app_config(cls, app_model: App,
                       app_model_config: AppModelConfig,
                       conversation: Optional[Conversation] = None,
                       override_config_dict: Optional[dict] = None) -> CustomAgentAppConfig:
        """
        ...
        app_config = CustomAgentAppConfig(
